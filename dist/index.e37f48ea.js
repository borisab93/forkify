...
},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./config.js":"k5Hzs","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi","./views/bookmarksview.js":"kkwkM","./views/addRecipeView.js":"i6DNj","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports,__globalThis) {
'use strict';
...
const updateServings = function(newServings) {
    ...
    //newQt = oldQt 8 newServings / oldServings
    });
...
const KEY = 'f7ff0c00-f65b-4253-8335-8aac2b4e8a5f';
...
},{"./config":"k5Hzs","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"l60JC":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    _formatFraction(value) {
        ...
        for (const [dec, frac] of Object.entries(fractionMap)){
            if (Math.abs(roundedDecimal - parseFloat(dec)) < 0.01) return frac;
        }
        const wholeNumber = Math.floor(value);
        const decimalPart = value - wholeNumber;
        if (decimalPart > 0) {
            if (Math.abs(decimalPart - 0.25) < 0.05) return wholeNumber > 0 ? `${wholeNumber} 1/4` : '1/4';
            if (Math.abs(decimalPart - 0.33) < 0.05) return wholeNumber > 0 ? `${wholeNumber} 1/3` : '1/3';
            if (Math.abs(decimalPart - 0.5) < 0.05) return wholeNumber > 0 ? `${wholeNumber} 1/2` : '1/2';
            if (Math.abs(decimalPart - 0.67) < 0.05) return wholeNumber > 0 ? `${wholeNumber} 2/3` : '2/3';
            if (Math.abs(decimalPart - 0.75) < 0.05) return wholeNumber > 0 ? `${wholeNumber} 3/4` : '3/4';
        }
        return decimal;
    }
    _generateMarkup() {
...
},{"./View.js":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5cUXS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"./View.js":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kkwkM":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
